...
All in One SEO Pack (Pro) multilingual integration for [WP-LOC](https://wp-loc.com/). Companion to `wp-loc-woocommerce` and `wp-loc-multicurrency`.
...
All WP-LOC API access is funnelled through `WP_LOC_AIOSEO_Lang`.
